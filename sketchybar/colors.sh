...
#export BAR_COLOR=0xff1a1b26     # Dark background
#export ITEM_BG_COLOR=0xff343a46  # Slightly lighter background for items
export ACCENT_COLOR=0xff7aa2f7   # Blue accent color
